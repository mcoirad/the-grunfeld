...
signing_lose_list: '<ul>
  ...
  <li>Signed Shabazz Muhammad in 2013.</li>

  <li>Signed Tayshaun Prince in 2015.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Ronny Turiaf in 2013.</li>

  <li>Signed Arinze Onuaku in 2015.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Added Anthony Bennett, Andrew Wiggins, Thaddeus Young to MIN.</li>

  <li>Lost Luc Mbah a Moute, Alexey Shved to PHI.</li>
...
trade_win_list: '<ul>
  ...
  <li>Lost Rakeem Christmas, Cedi Osman, Justin James to CLE.</li>
