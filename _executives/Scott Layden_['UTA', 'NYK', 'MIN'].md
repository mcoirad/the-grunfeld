...
signing_lose_list: '<ul>
  ...
  <li>Signed Greg Foster in 1995.</li>

  <li>Signed Howard Eisley in 1995.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Ruben Nembhard in 1997.</li>

  <li>Signed Chad Gallagher in 1994.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Added Antonio McDyess, Frank Williams, Maciej Lampe to NYK.</li>
...
trade_win_list: '<ul>
  ...
  <li>Lost Felton Spencer to ORL.</li>
