...
draft_bust_list: '<ul>
  ...
  <li>Drafted Armen Gilliam with 2th pick but was worth 47th pick.</li>

  <li>Drafted William Bedford with 6th pick but was worth 52th pick.</li>

  <li>Drafted Ricky Sobers with 16th pick but was worth 53th pick.</li>

  </ul>'
draft_description: Jerry Colangelo ranks in the 84th percentile for drafting among
...
signing_description: 'Jerry Colangelo ranks in the 40th percentile for free agency
  signings among executives in our database. '
signing_lose_list: '<ul>

  <li>Signed Joe Kleine in 1993.</li>

  <li>Signed Jeff Cook in 1979.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Elliot Perry in 1994.</li>

  <li>Signed Danny Ainge in 1992.</li>
...
team_shortcode:
- PHO
trade_description: 'Jerry Colangelo ranks in the 44th percentile for trading among
...
trade_win_list: '<ul>
  ...
  <li>Lost Jeff Hornacek, Andrew Lang, Tim Perry to PHI.</li>
