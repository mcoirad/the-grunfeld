...
is_active: true
name: Danny Ainge
signing_description: 'Danny Ainge ranks in the 84th percentile for free agency signings
  among executives in our database. '
signing_lose_list: '<ul>

  <li>Signed Brian Scalabrine in 2005.</li>

  <li>Signed Simone Fontecchio in 2022.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Walker Kessler in 2022.</li>
...
- BOS
- UTA
trade_description: 'Danny Ainge ranks in the 71th percentile for trading among executives
  in our database. '
trade_lose_list: '<ul>

  <li>Added Ochai Agbaji, Lauri Markkanen, Collin Sexton to UTA.</li>
