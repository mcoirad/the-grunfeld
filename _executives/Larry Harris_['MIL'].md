...
signing_lose_list: '<ul>
  ...
  <li>Signed Charlie Bell in 2005.</li>

  <li>Signed Royal Ivey in 2007.</li>

  <li>Signed Erick Strickland in 2003.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Anthony Goldwire in 2005.</li>

  <li>Signed Mike James in 2004.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Added Charlie Villanueva to MIL.</li>

  <li>Lost T.J. Ford to TOR.</li>
...
trade_win_list: '<ul>
  ...
  <li>Lost Desmond Mason, Cedric Simmons to NOK.</li>
