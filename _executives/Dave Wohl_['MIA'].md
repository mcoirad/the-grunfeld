...
signing_lose_list: '<ul>
  ...
  <li>Signed Isaac Austin in 1996.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Voshon Lenard in 1995.</li>

  <li>Signed P.J. Brown in 1996.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Added Tony Smith to MIA.</li>

  <li>Lost Terrence Rencher to PHO.</li>
...
trade_win_list: '<ul>
  ...
  <li>Added Chris Gatling, Tim Hardaway to MIA.</li>

  <li>Lost Bimbo Coles, Kevin Willis to GSW.</li>
