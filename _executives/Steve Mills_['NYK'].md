...
signing_lose_list: '<ul>
  ...
  <li>Signed Frank Ntilikina in 2017.</li>

  <li>Signed Damyean Dotson in 2017.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Luke Kornet in 2018.</li>

  <li>Signed Trey Burke in 2018.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Lost Justin Jackson to DEN.</li>
...
trade_win_list: '<ul>
  ...
  <li>Lost Carmelo Anthony to OKC.</li>
