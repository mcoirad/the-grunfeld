...
signing_lose_list: '<ul>
  ...
  <li>Signed Sam Jacobson in 2000.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Speedy Claxton in 2003.</li>

  <li>Signed Earl Boykins in 2002.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Added Antawn Jamison to GSW.</li>
...
trade_win_list: '<ul>
  ...
  <li>Lost Brian Shaw, Joe Smith to PHI.</li>
