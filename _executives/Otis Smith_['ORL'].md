...
signing_lose_list: '<ul>
  ...
  <li>Signed Chris Duhon in 2010.</li>
...
signing_win_list: '<ul>
  ...
  <li>Signed Mickaël Piétrus in 2008.</li>

  <li>Signed Jason Williams in 2009.</li>
...
trade_lose_list: '<ul>
  ...
  <li>Added Brian Cook, Maurice Evans to ORL.</li>
...
trade_win_list: '<ul>
  ...
  <li>Lost Rafer Alston, Tony Battie, Courtney Lee to NJN.</li>
