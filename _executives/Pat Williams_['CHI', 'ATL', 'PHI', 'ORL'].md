...
signing_win_list: '<ul>
  ...
  <li>Signed Ollie Johnson in 1980.</li>
...
- PHI
- ORL
trade_description: 'Pat Williams ranks in the 62th percentile for trading among executives
  in our database. '
trade_lose_list: '<ul>
...
trade_win_list: '<ul>
  ...
  <li>Lost George McGinnis, Mike Evans to DEN.</li>
